...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0<goal and score1<goal:  # 直到有人达到目标分数才结束s
        if not who:  # 选手1
            score0 += take_turn(strategy0(score0, score1), score1, dice)  # 选手1投一次骰子后的得分
            ...
            score1 += take_turn(strategy1(score1, score0), score0, dice)  # 选手2投一次骰子后的得分
            say = say(score0, score1)
...
def make_averaged(original_function, trials_count=1000):
    ...
    "*** YOUR CODE HERE ***"
    def average(*arg):
        num = (original_function(*arg) for i in range(trials_count))  # 投骰子目标次数生成的点数
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    return 0 if bacon_strategy(score, opponent_score, cutoff, num_rolls)==0\
            ...
            else num_rolls # Replace this statement
    # END PROBLEM 11
